      ...
      <div className="flex-1 bg-gradient-to-b from-primary/10 to-background py-12">
        <div className="container max-w-4xl">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-4xl font-serif font-bold mb-2">게시물 수정</h1>
            <p className="text-muted-foreground">게시물 정보를 수정하세요</p>
          </div>
          ...
          <form onSubmit={handleSubmit}>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    {isSearchingLocation ? "위치를 검색하는 중..." : "목적지를 변경하면 위도/경도가 자동으로 검색됩니다"}
                  </p>
                </div>
            ...
            <div className="flex gap-4">
              <Button type="submit" disabled={updatePostMutation.isPending} className="flex-1">
